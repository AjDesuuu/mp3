<%-- 
    Document   : success
    Created on : Feb 15, 2024, 11:48:11 PM
...
<head>
            ...
            <div class="container"><a class="navbar-brand d-flex align-items-center" href=""><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <form action="index.jsp" method="POST">
                        <input class="btn btn-primary shadow"type="submit" value="Logout">
                    </form>
                ...
                <div class="row pt-5">
                    <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                        <div class="text-center">
                            <p class="fw-bold text-success mb-2">Welcome back!</p>
                            <h1 class="fw-bold">Welcome <% out.print(session.getAttribute("username")); %>, your role is <% out.print(session.getAttribute("role")); %></h1>
                        </div>
                    </div>
    ...
    <section class="py-5">
        <div class="container text-center py-5">
            <p class="mb-4" style="font-size: 1.6rem;">Insert a&nbsp;<span class="text-success"><strong>really cool</strong></span>&nbsp;line here.</p><a href="#"> <img class="m-3" src="assets/img/brands/google.png"></a><a href="#"> <img class="m-3" src="assets/img/brands/microsoft.png"></a><a href="#"> <img class="m-3" src="assets/img/brands/apple.png"></a><a href="#"> <img class="m-3" src="assets/img/brands/facebook.png"></a><a href="#"> <img class="m-3" src="assets/img/brands/twitter.png"></a>
        </div>
    </section>
